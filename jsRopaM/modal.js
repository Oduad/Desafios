...
profesor.addEventListener('click', () => {
    swa(`Agradecimientos al profesor Fernando Luna por su entrega y dedicación en cada clase. <br> &#127891 &#127891; &#127891;`, "#ffff99", 4000, 'success')
...
tutor.addEventListener('click', () => {
    swa(`Agradecimientos al tutor Julio César Caro Cota por su tiempo en cada una de las dudas. <br> &#127891 &#127891; &#127891;`, "#ffff99", 4000, 'success')
})